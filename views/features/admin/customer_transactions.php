...
<html
  ...
  <head>
    ...
    <title>Transactions of <?=$name?></title>
  </head>
  <body class="h-full">
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        <tr>
                          ...
                          <td
                            class="whitespace-nowrap px-2 py-4 text-sm font-medium   <?=$transaction['transaction_type'] == 'deposit' ? 'text-emerald-600' : 'text-red-600'?>">
                           <?=$transaction['transaction_type'] == 'deposit' ? '+' : '-'?>$  <?=$transaction['amount']?>
                          </td>
                          <td
                            class="whitespace-nowrap px-2 py-4 text-sm text-gray-500">
                             <?=date('d-M-Y h:i:s a', strtotime($transaction['date']))?>
